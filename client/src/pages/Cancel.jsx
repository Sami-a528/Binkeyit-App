...
const Cancel = () => {
    return (
        <div className='m-2 w-full max-w-md bg-red-200 p-4 py-5 rounded mx-auto flex flex-col justify-center items-center gap-5'>
            ...
            <Link to="/" className='border border-red-800 text-red-900 hover:bg-red-900 hover:text-white rounded-2xl cursor-pointer transition-all px-4 py-1'>Go To Home</Link>
        </div>
    )
}
