...
import CategoryWiseProductDisplay from '../component/CategoryWiseProductDisplay.jsx'
  ...
  return (
    <section className='bg-white'>
      <div className='container mx-auto '>
        <div className={`w-full h-full min-h-48 bg-green-200 rounded ${!banner && "animate-pulse my-2"} `}>
          <img src={banner} alt="banner" className='w-full h-full hidden lg:block' />
          <img src={bannerMobile} alt="bannerMobile" className='w-full h-full lg:hidden' />
        </div>
      </div>
